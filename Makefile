...
#RTL COMPILE OPTS 
RTL_COMPILE_OPTS += +incdir+$(GIT_HOME)/RTL2
...
VIP_COMPILE_OPTS += +incdir+/home/blr_user1/DV0704/AHB_VIP/design_dir/include/sverilog
VIP_COMPILE_OPTS += +incdir+/home/blr_user1/DV0704/AHB_VIP/design_dir/src/sverilog/vcs
#VIP_COMPILE_OPTS += +incdir+/home/blr_user1/DV0704/AHB_VIP/design_dir/examples/sverilog/amba_svt/tb_ahb_svt_uvm_basic_sys/env
...
TB_COMPILE_OPTS += +incdir+$(GIT_HOME)/verif/uvc/ahb_uvc/env
TB_COMPILE_OPTS += +incdir+$(GIT_HOME)/verif/uvc/ahb_uvc/seq
TB_COMPILE_OPTS += +incdir+$(GIT_HOME)/verif/uvc/ahb_uvc/cfg

TB_COMPILE_OPTS += +incdir+$(GIT_HOME)/verif/uvc/ppi_uvc/seq
TB_COMPILE_OPTS += +incdir+$(GIT_HOME)/verif/uvc/ppi_uvc/env/agent
TB_COMPILE_OPTS += +incdir+$(GIT_HOME)/verif/uvc/ppi_uvc/env

TB_COMPILE_OPTS += +incdir+$(GIT_HOME)/verif/uvc/pixel_uvc/seq
TB_COMPILE_OPTS += +incdir+$(GIT_HOME)/verif/uvc/pixel_uvc/env/agent
TB_COMPILE_OPTS += +incdir+$(GIT_HOME)/verif/uvc/pixel_uvc/env
TB_COMPILE_OPTS += +incdir+$(GIT_HOME)/verif/uvm_tb/chk
TB_COMPILE_OPTS += +incdir+$(GIT_HOME)/verif/uvm_tb/env
TB_COMPILE_OPTS += +incdir+$(GIT_HOME)/verif/uvm_tb/env/env_if
TB_COMPILE_OPTS += +incdir+$(GIT_HOME)/verif/uvm_tb/test
...
run:
	./simv +UVM_TESTNAME=$(UVM_TEST) $(COMMON_RUN_OPTS) $(RUN_OPTS)
clean:
